...
export declare type IQCallback2<T> = (response?: T, error?: Error) => void;
export declare type IQCallback1 = (error?: Error) => void;
export declare type IQProgressListener<O = string> = (error?: Error, progress?: number, url?: O) => void;
...
export interface IQiscus {
    ...
    setUser(userId: string, userKey: string, username: string, avatarUrl: string, extras: object, callback: IQCallback2<IQUser>): void | Promise<IQUser>;
    ...
    updateUser(username?: string, avatarUrl?: string, extras?: object, callback?: IQCallback2<IQUser>): void | Promise<IQUser>;
    getUsers(searchUsername?: string, page?: number, limit?: number, callback?: IQCallback2<IQUser[]>): void | Promise<IQUser[]>;
    ...
    createGroupChat(name: string, userIds: string[], avatarUrl: string, extras: object, callback?: IQCallback2<IQRoom>): void | Promise<IQRoom>;
    createChannel(uniqueId: string, name: string, avatarUrl: string, extras: object, callback?: IQCallback2<IQRoom>): void | Promise<IQRoom>;
    getChannel(uniqueId: string, callback?: IQCallback2<IQRoom>): void | Promise<IQRoom>;
    updateChatRoom(roomId: number, name: string, avatarUrl: string, extras: object, callback?: IQCallback2<IQRoom>): void | Promise<IQRoom>;
    addParticipants(roomId: number, userIds: string[], callback?: IQCallback2<IQParticipant[]>): void | Promise<IQParticipant[]>;
    removeParticipants(roomId: number, userIds: string[], callback?: IQCallback2<IQParticipant[]>): void | Promise<IQParticipant[] | string[]>;
    getChatRoomWithMessages(roomId: number, callback?: IQCallback2<IQRoom>): void | Promise<IQRoom>;
    getChatRooms(roomIds: number[], page?: number, showRemoved?: boolean, showParticipant?: boolean, callback?: IQCallback2<IQRoom[]>): void | Promise<IQRoom[]>;
    getChatRooms(uniqueIds: string[], page?: number, showRemoved?: boolean, showParticipant?: boolean, callback?: IQCallback2<IQRoom[]>): void | Promise<IQRoom[]>;
    getAllChatRooms(showParticipant?: boolean, showRemoved?: boolean, showEmpty?: boolean, page?: number, limit?: number, callback?: IQCallback2<IQRoom[]>): void | Promise<IQRoom[]>;
    getParticipants(roomUniqueId: string, offset?: number, sorting?: 'asc' | 'desc' | null, callback?: IQCallback2<IQParticipant[]>): void;
    ...
    getPreviouseMessagesById(roomId: number, limit?: number, messageId?: number, callback?: IQCallback2<IQMessage[]>): void | Promise<IQMessage[]>;
    getNextMessagesById(roomId: number, limit?: number, messageId?: number, callback?: IQCallback2<IQMessage[]>): void | Promise<IQMessage[]>;
    ...
    sendFileMessage(roomId: number, message: string, file: File, callback: (error: Error, progress: number, message: IQMessage) => void): void;
...
export declare type QNonce = {
    expired: number;
    nonce: string;
};
export declare enum IQRoomType {
    Group = "group",
    Single = "single"
}
...
export declare enum IQMessageType {
    Text = "text",
    Custom = "custom",
...
export interface IQMessageAdapter {
    readonly messages: Atom<{
        [key: string]: IQMessage;
    }>;
